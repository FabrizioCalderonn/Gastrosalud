...
import { getSlotDurationMinutes } from "@/lib/scheduling";
...
export default async function NuevaCitaPage() {
  ...
  const defaultDurationMinutes = await getSlotDurationMinutes();

  return (
    <div className="mx-auto max-w-[640px]">
      <h1 className="mb-6 font-heading text-2xl font-extrabold text-ink">Nueva cita</h1>
      <NewAppointmentForm defaultDurationMinutes={defaultDurationMinutes} />
    </div>
  );
}
